							...
							?>
									<tr>
										<td class="text-center align-middle">
		        							<a href="javascript:void(0)" id="add_to_purchase">
...
<div class="modal fade" id="SelectItemModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 	<div class="modal-dialog">
	   <div class="modal-content">
   		<div class="modal-header">
	        	<h5 class="modal-title" id="addToPurchaseModalLabel">Add to purchase</h5>
	        	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	         	<span aria-hidden="true">&times;</span>
	        	</button>
     	 	</div>
   		<div class="modal-body" style="padding:12px 0px !important">
				<div id="add_to_purchase_form">
...
<script type="text/javascript">
	...
	$("#LoadItemsInModal").delegate("#add_to_purchase", "click", function(e) {
		...
		if (isRequired) {
            ...
            $.ajax({
                ...
                success : function(response) {
                    ...
                    if (empty_check) {
                        $('#editpurchase_items').children("tr:eq(1)").remove();
                    }

                    $("#editpurchase_items").append(response);
