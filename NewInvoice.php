				...
				<div id="demand_layout">
					...
					<form id="invoice_form">
						...
						<div class="row mt-1">
							...
							<input type="hidden" name="generated_by" value="<?php echo $username; ?>">
						...
						<div class="row mt-1" style="font-size: 15px;">
							...
							<div class="col-md-6 mt-1">
								...
								<input type="" id="po_no" name="po_no" class="form-control form-control-sm po_no" placeholder="20240209-001010-01" oninput="<?php echo $forInvoiceNo; ?>" maxlength="18">
							</div>
						</div>
					  	...
					  	<div class="col-md-12 p-0 mt-1">
					    	...
					    	<textarea rows="3" name="comment" form="invoice_form" class="form-control form-control-sm comment" placeholder="Aa" maxlength="299"><?php if ( isset($comment)) { echo $comment; }?></textarea>
					  	</div>
					  	
					   <input type="hidden" name="action" value="saveInvoice" />
					  	<div class="form-group text-center mt-3">
					    	<input type="submit" id="form_submit_button" name="new_invoice" value="Generate" class="new_invoice">
					  	</div>
					</form>
		</div>
		</div>
...
<script type="text/javascript" src="js/createinvoice.js?clear_cache=<?php echo time();?>"></script>
<script type="text/javascript">
	
	$("#client_id").hover(function(){
